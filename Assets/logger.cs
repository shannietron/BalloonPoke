...
public class logger : MonoBehaviour {
    ...
    public static void logCoords(float logTime,Transform logTransform,bool success,float logDuration,float myScale)
    {
        if (success)
        {
            System.IO.File.AppendAllText(TargetSuccessfilePath, logTime.ToString() + ',' + myScale.ToString() + ',' + logDuration.ToString() + ',' + logTransform.position.x.ToString() + ',' + logTransform.position.y.ToString() + ',' + logTransform.position.z.ToString() + System.Environment.NewLine);
        }
        else
        {
            System.IO.File.AppendAllText(TargetFailfilePath, logTime.ToString() + ',' + myScale.ToString() + ',' + logDuration.ToString() + ',' + logTransform.position.x.ToString() + ',' + logTransform.position.y.ToString() + ',' + logTransform.position.z.ToString() + System.Environment.NewLine);
        }
    }
}